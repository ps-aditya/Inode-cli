...
- [ ] Wire into CLI as `tra parse <command...>` (done as a debug utility)

## Sprint 2 — Risk Engine (next)
- [ ] JSON-based rule schema (no AI)
- [ ] Rule matcher: `ParsedCommand -> RiskAssessment`
- [ ] Initial rule set: force push, hard reset, branch deletion, `rm -rf`
- [ ] Tests per rule
